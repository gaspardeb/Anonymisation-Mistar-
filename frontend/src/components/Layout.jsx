...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-cream-100">
      <aside className="w-56 bg-white border-r border-cream-300 flex flex-col shrink-0">
        ...
        <nav className="flex-1 px-3 py-3 space-y-3 overflow-y-auto">
          <NavSection>
            ...
            <NavItem to="/scan-anonymizer" label="Anonymisation scan" icon={<IconScan />} />
